...
const PortfolioCard: React.FC<PortfolioCardProps> = ({ url, title }) => {
  return (
    <a
      ...
      target='_blank'
    >
      <div className='bg-white mt-10 transition p-10 w-96 h-48 border border-gray-200 rounded-lg cursor-pointer hover:shadow-2xl hover:border-none hover:scale-125'>
